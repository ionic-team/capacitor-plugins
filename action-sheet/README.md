...
| **`cancelable`** | <code>boolean</code>             | If true, sheet is canceled when clicked outside; If false, it is not. By default, false. On iOS, the sheet is also cancelable if a button with <a href="#actionsheetbuttonstyle">ActionSheetButtonStyle.Cancel</a> is provided and cancelable is false. On Web, requires having @ionic/pwa-elements version 3.4.0 or higher. | 8.1.0 |
