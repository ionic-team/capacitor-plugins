...
| **`schedule`**         | <code><a href="#schedule-1">Schedule</a></code> | <a href="#schedule-1">Schedule</a> this notification for a later time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 1.0.0 |
...
Represents a <a href="#schedule-1">schedule</a> for a notification.
