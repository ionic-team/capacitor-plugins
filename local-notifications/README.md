...
| **`interruptionLevel`** | <code><a href="#interruptionlevel">InterruptionLevel</a></code> | Sets the interruption level for this notification. Only available for iOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 4.2.0 |
...
| **`PASSIVE`**        | <code>0</code> |
| **`ACTIVE`**         | <code>1</code> |
| **`TIME_SESIITIVE`** | <code>2</code> |
| **`CRITICAL`**       | <code>3</code> |
