...
| **`inboxList`**        | <code>string[]</code>                         | Sets list of strings for display in an inbox style notification. Up to 5 strings are allowed. Only available for Android when `notificationStyle` is set to `inbox`.                                                                                                                                                                                                                                        | 1.0.0 |
