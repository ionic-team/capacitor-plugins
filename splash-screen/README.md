...
| **`androidSplashResourceName`** | <code>string</code>                                                                                                           | Name of the resource to be used as Splash Screen. Doesn't work if `useDialog` is true. Only available on Android.                                                                                            | <code>splash</code> | 1.0.0 |
