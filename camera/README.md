...
| **`thumbnailPath`**    | <code>string</code>  | If using the CameraREsultType.Uri, the path will contain a full, platform-specific file URL that can be read later usijng the Filesystem API.                                                                                                                            |       |
| **`thumbnailWebPath`** | <code>string</code>  | thumbnailWebPath returns a path that can be used to set the src attribute of an image for efficient loading and rendering                                                                                                                                                |       |
...
| **`saveToDataDirectory`** | <code>boolean</code>                                          | (FarmQA) iOS and Android only: Whether to save the result images to the Data directory when the resultType is <a href="#cameraresulttype">CameraResultType.Uri</a>.                                                                                                        |                                     |       |
| **`resultFilename`**      | <code>string</code>                                           | (FarmQA) iOS and Android only: The image filename when saving to the Data directory.                                                                                                                                                                                       |                                     |       |
| **`createThumbnail`**     | <code>boolean</code>                                          | (FarmQA) iOS and Android only: Whether to create a thumbnail image in the Data directory.                                                                                                                                                                                  |                                     |       |
| **`thumbnailFilename`**   | <code>string</code>                                           | (FarmQA) iOS and Android only: The thumbnail filename when saving to the Data directory.                                                                                                                                                                                   |                                     |       |
| **`thumbnailWidth`**      | <code>number</code>                                           | (FarmQA) iOS and Android only: The width of the thumbnail image.                                                                                                                                                                                                           |                                     |       |
| **`thumbnailHeight`**     | <code>number</code>                                           | (FarmQA) iOS and Android only: The height of the thumbnail image.                                                                                                                                                                                                          |                                     |       |
